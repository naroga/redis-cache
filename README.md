...
![Build status](https://travis-ci.org/naroga/redis-cache.svg?branch=master) [![Coverage Status](https://coveralls.io/repos/github/naroga/redis-cache/badge.svg?branch=master)](https://coveralls.io/github/naroga/redis-cache?branch=master)
